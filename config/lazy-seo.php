...
return [
    ...
    */
    ...
    'sitemap' => [
        ...
        'cache_store' => env('LAZY_SEO_SITEMAP_CACHE_STORE'),
        'cache_minutes' => env('LAZY_SEO_SITEMAP_CACHE_MINUTES', 60),
        'cache_tags_enabled' => env('LAZY_SEO_SITEMAP_CACHE_TAGS_ENABLED', false),
        ...
        'max_urls' => (int) env('LAZY_SEO_SITEMAP_MAX_URLS', 0),
