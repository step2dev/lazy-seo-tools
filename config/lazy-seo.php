...
return [
    ...
    */
    'features' => [
        ...
        'crawler' => env('LAZY_SEO_FEATURE_CRAWLER', false),
        'monitoring' => env('LAZY_SEO_FEATURE_MONITORING', false),
        'indexnow' => env('LAZY_SEO_FEATURE_INDEXNOW', false),
        'content_intelligence' => env('LAZY_SEO_FEATURE_CONTENT_INTELLIGENCE', false),
        'og_image' => env('LAZY_SEO_FEATURE_OG_IMAGE', false),
        'livewire' => env('LAZY_SEO_FEATURE_LIVEWIRE', false),
        'admin' => env('LAZY_SEO_FEATURE_ADMIN', false),
        'api' => env('LAZY_SEO_FEATURE_API', false),
    ],
