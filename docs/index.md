...
- Site crawler, SEO monitoring snapshots, history summaries and issue tracking.
- IndexNow submission and database logging.
- Content intelligence checks for HTML files.
- Optional Livewire admin UI, optional web routes and optional headless API routes.
...
5. Enable redirects, sitemap, monitoring, IndexNow, Livewire admin or API routes only when the application needs them.
