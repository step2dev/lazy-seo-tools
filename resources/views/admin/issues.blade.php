<!doctype html>
<html lang="en">
<head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Lazy SEO Issues</title>@livewireStyles</head>
<body style="margin:0; padding:2rem; background:#f8fafc; color:#0f172a;">
    <main style="max-width:1200px; margin:0 auto; display:grid; gap:1.5rem;">
